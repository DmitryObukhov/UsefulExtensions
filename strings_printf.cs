...
{
    public static class StringPrintfExtension
    {
        public static string sprintf(this string strVariable, params object[] Parameters)
        {
            string retVal = Printf.sprintf(strVariable,Parameters);
            return retVal;
        }
    }
    ...
    {
        // This wonderful code is shared by Richard Prinz under MIT license
